...
#define STRING_CONFIG_H_AUTHOR "DevilClarke" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Marlin 1.1.9" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "JGAurora Z-603S"         // will be shown during bootup in line 2
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_JGA_Z603S_B
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
//#define CUSTOM_MACHINE_NAME "JGAurora Z-603S"
